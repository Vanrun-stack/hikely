...
import { Mountain, Mail, Lock, User, Github, Loader2 } from 'lucide-react';
      ...
      >
        ...
        <Card className="border-border/50 shadow-xl">
          <CardHeader className="text-center pb-2">
            <CardTitle className="text-2xl">Rejoindre Hikely</CardTitle>
            <CardDescription>
              Créez votre compte et explorez la communauté
            </CardDescription>
          </CardHeader>
